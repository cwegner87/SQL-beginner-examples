...
-- A: Create a new table to keep track of what employee is an expert in what
-- Q: What type of relationship is this? (e.g. 1-1, 1-many, or many-to-many?)
-- A: many to many, becuase an employee can be an expert in many categories.
...
INSERT INTO employees_categories ('employee ID', 'category ID') 
